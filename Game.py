...
# Размещение игры по центру экрана
...
# Инициализация пайгейма и создание окна
pygame.init()
...
# Создание и движение заднего фона
class Background:
...
# Создание и передвижение отдельных задних фонов
...
# Создание и передвижение задних классов
class Cactus:
...
class Dino:
    ...
    def __init__(self):
        ...
        # Эффект движения для спрайтов
        self.idle_index = 0
        self.running_index = 0
        self.jumping_index = 0

        # Определение показов спрайтов
        self.idle = True
        self.running = False
        self.jumping = False
        self.falling = False
...
class GameOver:
    ...
    def draw(self):
        draw_text("GAME OVER", "font/northcliff_stencil.otf", 80, (153, 204, 225),
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if game_over:
                    # Проверка на нажатие Play Again
        ...
        pygame.display.flip()  # Очистка перед еще одним циклом
